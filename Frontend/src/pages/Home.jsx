                    ...
                    <div className = 'title is-hidden-tablet is-3 is-quicksand has-text-centered'>Get started!</div>
                            ...
                            <div className = 'columns' style={{paddingBottom:'10px',paddingTop:'10px'}}>
                                <div className = 'column' style={{width:'50%'}}>
                                    <div className='hovero'>
                                        <img data-aos = 'fade-right'style={{height:'370px',width:'750px'}} id = 'ticket-section'  src = {SamhitaTicket} alt= "Samhita '22 ticket" />
                                    </div>
                                    <br />
                                    <br />                                    
                            </div>
                            <div className = 'column is-narrow' style = {{display: 'flex', flexDirection: 'row', alignItems: 'center',paddingRight:'20px'}}>
                            <div data-aos = 'fade-right' className = 'field'>
                                        <div className = 'control'>
                                            <div className = 'subtitle is-5 is-lato benefits-title ' style={{color:'white'}}>
                        ...
                        <div className='' style={{width:'100%',textAlign:'center'}}>
                                    <div data-aos = 'fade-right' className = 'control is-hidden-mobile'>
                                        <div className = ' is-centered subtitle is-3 is-quicksand' style={{color:'white',textAlign:'center'}}>
                                            Book yours now!
                                        </div>
                                        <button className = 'hovero button is-rounded is-lato has-text-weight-semibold is-centered' style={{display:'block',backgroundColor:'#1d9c9c',border:'1px solid #1d9c9c',margin:'auto'}} onClick = {() => this.props.history.push(`/checkout/${encryptedId}`)}>
                                    ...
                                    <div className = 'control is-hidden-tablet'>
                                        <button className = 'button is-rounded is-lato has-text-weight-semibold is-danger is-centered'style={{textAlign:'center'}} onClick = {() => this.props.history.push(`/checkout/${encryptedId}`)}>
                                            <span>Get Ticket!</span>
                                            <span className = 'icon'>
                                                <FontAwesomeIcon icon = {faArrowRight} />
                                            </span>
                ...
                <div className='container'>
                    <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner">
                            ...
                            <img className="d-block w-10" src={SamhitaLogo} alt="First slide" />
                            </div>
                            <div className="carousel-item">
                            <img className="d-block w-10" src={SamhitaTicket} alt="Second slide" />
                            </div>
                            <div className="carousel-item">
                            <img className="d-block w-10" src={ACTLogo} alt="Third slide" />
                            </div>
                        </div>
